...
class Ui_chk_Dialog(object):
    def setupUi(self, chk_Dialog):
        ...
        self.chk_D_button_1.setStyleSheet(u"background: #FFAB7C;color: #FFFFFF;")
        ...
        self.chk_D_button_2.setStyleSheet(u"background: #FFAB7C;color: #FFFFFF;")

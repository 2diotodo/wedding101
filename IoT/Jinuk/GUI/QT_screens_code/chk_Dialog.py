...
class Ui_chk_Dialog(object):
    def setupUi(self, chk_Dialog):
        ...
        chk_Dialog.resize(1036, 776)
        chk_Dialog.setStyleSheet(u"background: #FFF3C8;")
        self.chk_D_frame = QFrame(chk_Dialog)
        self.chk_D_frame.setObjectName(u"chk_D_frame")
        self.chk_D_frame.setGeometry(QRect(52, 39, 932, 698))
        ...
        self.chk_D_button_1.setGeometry(QRect(180, 440, 241, 121))
        font = QFont()
        ...
        self.chk_D_button_2.setGeometry(QRect(540, 440, 241, 121))
        ...
        self.chk_D_label.setGeometry(QRect(230, 150, 481, 221))
        font1 = QFont()

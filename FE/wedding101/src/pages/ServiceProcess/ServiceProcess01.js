          ...
          <div className='contentbox'>
            ...
            <div className='article-form'>
              <input
                ...
                id='promoCheck'
                checked={promoCheck}
                onChange={promoBtnEvent}
              />
              <label for='promoCheck'>
                <ServiceTerms terms={3} /> <span className='not-required'>(선택)</span>
              </label>
            </div>
          </div>
